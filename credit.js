...
function AnimeGirlSound() {
	console.log("ehe (￣ε￣＠)");
	var onniichan = document.getElementById('onniichan');
	var nyaa = document.getElementById('nyaa');
	var yayy = document.getElementById('yayy');
	var yes = document.getElementById('yes');
	var ohayo = document.getElementById('ohayo');
	var arr = [onniichan, nyaa, yayy, yes, ohayo];
	var idx = Math.floor(Math.random() * arr.length);
	arr[idx].play();
}

function AnimeGirlClick() {
	console.log("Bang bang ehe (￣ε￣＠)");
